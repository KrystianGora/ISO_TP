...
/*
 * @brief Function returns whether Tx State Machine is busy (ISOTP_SENDING_OTHER_MSG_IN_PROGRESS) or not (ISOTP_NO_ERROR)
 * @return ISOTP Error Status
 */
